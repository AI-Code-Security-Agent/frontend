...
//             </Link>
//             <Link href="/dashboard">
//               <Button size="lg" variant="outline" className="h-12 bg-white/10 dark:bg-white/5 border-white/20 dark:border-white/10 hover:bg-white/20 dark:hover:bg-white/10 backdrop-blur-sm">
...
//                   <h3 className="font-bold text-gray-900 dark:text-white">Smart Code Analysis</h3>
...
//                 <div className="space-y-2">
//                   <h3 className="font-bold text-gray-900 dark:text-white">Threat Detection</h3>
//                   <p className="text-sm text-gray-600 dark:text-gray-300">
...
//                 <div className="space-y-2">
//                   <h3 className="font-bold text-gray-900 dark:text-white">Security Recommendations</h3>
//                   <p className="text-sm text-gray-600 dark:text-gray-300">
...
export default function Home() {
  ...
  // Handle Demo button click — show chat section
        ...
        <div className="relative z-10">
          ...
          <main className="flex min-h-screen flex-col items-center justify-center gap-6 pb-8 pt-6 md:py-10">
            ...
            <div className="flex gap-4">
              ...
              {/* Changed View Demo from Link to Button with click handler */}
              <Button
                size="lg"
                variant="outline"
