                ...
                <div className="text-center text-muted-foreground py-40">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
                    <div
                      ...
                      onClick={() => handleQuickAction("Hello! What can you help me with?")}
                    >
                    ...
                    <div
                      className="p-4 border rounded-lg hover:bg-muted/50 transition-colors cursor-pointer"
                      onClick={() => handleQuickAction("Can you explain what you're capable of?")}
                    >
                      <h3 className="font-semibold mb-2">Explore Capabilities</h3>
                      <p className="text-sm text-muted-foreground">
                ...
                <div className="flex justify-between items-center p-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex items-center space-x-2 px-3 py-1 bg-purple-100 dark:bg-purple-900 rounded-full">
                      ...
                      <span className="text-xs font-medium text-purple-800 dark:text-purple-200">LLM</span>
                    </div>
                  </div>
